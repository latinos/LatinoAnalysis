...
p1=PostProcessor(".",files1,cut=selection,branchsel=None,modules=[LeptonMaker(), LeptonSelLazy('Full2016', 'Loose', 1)],postfix='_lepMkr',provenance=True,fwkJobReport=True)
p1.run()
