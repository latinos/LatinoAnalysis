        ...
        'TightObjWP' : {
            ...
            'SusyMVAVLoose' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(0.887 + 0.088*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(0.112 + 0.099*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(-0.017 + 0.137*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(0.887)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(0.112)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(-0.017)' ] ,
                    } ,
                'tkSF':  { 
                    '1-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v2/EGM2D_BtoH_combineLowEt_RecoSF_Legacy2016.root' ,
                    } ,
            ...
            'SusyMVATight' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<40.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(3.447 + 0.063*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<40.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(2.522 + 0.058*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<40.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(1.555 + 0.075*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=40. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(4.392)' ] ,
                    'electron_col[LF_idx]["pt"]>=40. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(3.392)' ] ,
                    'electron_col[LF_idx]["pt"]>=40. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(2.680)' ] ,
                    } ,
                'tkSF':  { 
                    '1-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v2/EGM2D_BtoH_combineLowEt_RecoSF_Legacy2016.root' ,
                    } ,
        ...
        'TightObjWP' : {
            ...
            'SusyMVAVLoose' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(1.204 + 0.066*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(0.084 + 0.033*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(-0.123 + 0.053*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(1.204)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(0.084)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(-0.123)' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/egammaEffi.txt_EGM2D_updatedAll.root',
                    } ,
            ...
            'SusyMVATight' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] >  tanh(4.277 + 0.112*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(3.152 + 0.060*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(2.359 + 0.087*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(4.277)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(3.152)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > tanh(2.359)' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/egammaEffi.txt_EGM2D_updatedAll.root',
                    } ,
