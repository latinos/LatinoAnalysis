            ...
            'baseele' : { 
                'cuts' : { 
                    'True' :
                        ...
                        'abs(electron_col[LF_idx]["dxy"])       < 0.05' ,
                        'abs(electron_col[LF_idx]["dz"])        < 0.10' ,
                        'electron_col[LF_idx]["Electron_convVeto"] ==  1',
                        ] ,             
                    },
                } ,
            } ,
            ...
            'SusyMVAVLoose' : {
                'cuts' : { 
                    'True' :
                        ...
                        'abs(electron_col[LF_idx]["dz"])        < 0.10' ,
                        'electron_col[LF_idx]["Electron_convVeto"] ==  1',
                        'electron_col[LF_idx]["Electron_miniPFRelIso_all"]<0.4', 
                        ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 0.887 + 0.088*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 0.112 + 0.099*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > -0.017 + 0.137*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 0.887' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 0.112' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > -0.017' ] ,
                    } ,
                'tkSF':  { 
                    '1-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v2/EGM2D_BtoH_combineLowEt_RecoSF_Legacy2016.root' ,
                    } ,
            ...
            'SusyMVATight' : {
                'cuts' : { 
                    'True' :
                        ...
                        'electron_col[LF_idx]["Electron_convVeto"] ==  1',
                        'electron_col[LF_idx]["lostHits"]       ==  0',
                        'electron_col[LF_idx]["Electron_miniPFRelIso_all"]<0.2', 
                        ] ,
                    'electron_col[LF_idx]["pt"]<40.  && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 3.447 + 0.063*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<40.  && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 2.522 + 0.058*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<40.  && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 1.555 + 0.075*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]>=40. && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 4.392' ] ,
                    'electron_col[LF_idx]["pt"]>=40. && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 3.392' ] ,
                    'electron_col[LF_idx]["pt"]>=40. && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 2.680' ] ,
                    } ,
                'tkSF':  { 
                    '1-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v2/EGM2D_BtoH_combineLowEt_RecoSF_Legacy2016.root' ,
                    } ,
            ...
            'SusyMVATightMiniIsoTight' : {
                'cuts' : { 
                    'True' :
                        ...
                        'electron_col[LF_idx]["Electron_convVeto"] ==  1',
                        'electron_col[LF_idx]["lostHits"]       ==  0',
                        'electron_col[LF_idx]["Electron_miniPFRelIso_all"]<0.1', 
                        ] ,
                    'electron_col[LF_idx]["pt"]<40.  && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 3.447 + 0.063*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<40.  && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 2.522 + 0.058*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<40.  && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 1.555 + 0.075*(electron_col[LF_idx]["pt"] - 25)' ] ,
        ...
        'TightObjWP' : {
            ...
            'SusyMVAVLoose' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso >  (-0.788 + (0.148/15.)*(electron_col[LF_idx]["pt"]-10.))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > (-0.85 + (0.075/15.)*(electron_col[LF_idx]["pt"]-10.))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > (-0.81 + (0.077/15.)*(electron_col[LF_idx]["pt"]-10.))' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > -0.64' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > -0.775' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > -0.733' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017/egammaEffi.txt_EGM2D_runB_passingRECO_combineLowEt.root',
                    '2-2' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017/egammaEffi.txt_EGM2D_runC_passingRECO_combineLowEt.root',
            ...
            'SusyMVATight' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > 0.2+0.032*(electron_col[LF_idx]["pt"]-10)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > 0.1+0.025*(electron_col[LF_idx]["pt"]-10)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > -0.1+0.028*(electron_col[LF_idx]["pt"]-10)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > 0.68' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > 0.475' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V1noIso > 0.32' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017/egammaEffi.txt_EGM2D_runB_passingRECO_combineLowEt.root',
                    '2-2' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017/egammaEffi.txt_EGM2D_runC_passingRECO_combineLowEt.root',
        ...
        'TightObjWP' : {
            ...
            'SusyMVAVLoose' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 1.204 + 0.066*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 0.084 + 0.033*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > -0.123 + 0.053*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 1.204' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 0.084' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > -0.123' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/egammaEffi.txt_EGM2D_updatedAll.root',
                    } ,
            ...
            'SusyMVATight' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso >  4.277 + 0.112*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 3.152 + 0.060*(electron_col[LF_idx]["pt"] - 25)' ] ,
                    'electron_col[LF_idx]["pt"]<25.  && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 2.359 + 0.087*(electron_col[LF_idx]["pt"] - 25) ' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 4.277' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=0.8   && abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 3.152' ] ,
                    'electron_col[LF_idx]["pt"]>=25. && abs(electron_col[LF_idx]["eta"])>=1.479 && abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["Electron_mvaFall17V2noIso > 2.359' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/egammaEffi.txt_EGM2D_updatedAll.root',
                    } ,
            ...
            'looseMiniIsoLoose' : {
                'cuts' : { 
                    'True' :
                        ...
                        'abs(muon_col[LF_idx]["dxy"])       < 0.05' ,
                        'abs(muon_col[LF_idx]["dz"])        < 0.10' ,
                        'muon_col[LF_idx]["Muon_miniPFRelIso_all"] < 0.4' ,
                        ]
                    } ,
                'tkSF':  { 
                    '1-4' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016/trackerSF_Moriond17_MuoPOG_BCDEF.root' ,
            ...
            'mediumMiniIsoMedium' : {
                'cuts' : { 
                    'True' :
                        ...
                        'abs(muon_col[LF_idx]["dxy"])       < 0.05' ,
                        'abs(muon_col[LF_idx]["dz"])        < 0.10' ,
                        'muon_col[LF_idx]["Muon_miniPFRelIso_all"] < 0.2' ,
                        ] ,
                    } ,
                'tkSF':  { 
                    '1-4' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016/trackerSF_Moriond17_MuoPOG_BCDEF.root' ,
            ...
            'mediumMiniIsoTight' : {
                'cuts' : { 
                    'True' :
                        ...
                        'abs(muon_col[LF_idx]["dxy"])       < 0.05' ,
                        'abs(muon_col[LF_idx]["dz"])        < 0.10' ,
                        'muon_col[LF_idx]["Muon_miniPFRelIso_all"] < 0.1' ,
                        ] ,
                    } ,
                'tkSF':  { 
                    '1-4' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016/trackerSF_Moriond17_MuoPOG_BCDEF.root' ,
