...
samples['GluGluHToWWTo2L2Nu_M125']      .extend( ['xsec=0.6769',	'kfact=1.000',		'ref=KF'] ) # 29.99*0.215*0.108*0.108*9 ###Note: Changed XS from 43.92 (Higgs LHC value) to 29.99, which is used in this corresponding JHUgen sample
...
samples['GluGluHToWWTo2L2Nu_M1500']     .extend( ['xsec=0.00096',       'kfact=1.000',          'ref=KF'] ) # 0.01465*0.621*0.108*0.108*9  ###Note: BR for masses larger than 1 TeV are not given, so use that of 1 TeV instead (seems to be conservative anyway?)
samples['GluGluHToWWTo2L2Nu_M2000']     .extend( ['xsec=0.00041',       'kfact=1.000',          'ref=KF'] ) # 0.006227*0.621*0.108*0.108*9
samples['GluGluHToWWTo2L2Nu_M2500']     .extend( ['xsec=0.00016',       'kfact=1.000',          'ref=KF'] ) # 0.002515*0.621*0.108*0.108*9
samples['GluGluHToWWTo2L2Nu_M3000']     .extend( ['xsec=0.000078',      'kfact=1.000',          'ref=KF'] ) # 0.001186*0.621*0.108*0.108*9
...
samples['GluGluHToWWToLNuQQ_M115']  	.extend( ['xsec=0.6508',	'kfact=1.000',		'ref=KF'] ) # 34.69*0.0859*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M120']  	.extend( ['xsec=0.9919',	'kfact=1.000',		'ref=KF'] ) # 32.21*0.141*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M124']      .extend( ['xsec=1.3217',	'kfact=1.000',		'ref=KF'] ) # 30.41*0.199*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M125']      .extend( ['xsec=1.4083',	'kfact=1.000',		'ref=KF'] ) # 29.99*0.215*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M126']      .extend( ['xsec=1.4919',	'kfact=1.000',		'ref=KF'] ) # 29.57*0.231*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M130']      .extend( ['xsec=1.8530',	'kfact=1.000',		'ref=KF'] ) # 28.00*0.303*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M135']      .extend( ['xsec=2.2898',	'kfact=1.000',		'ref=KF'] ) # 26.21*0.400*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M140']      .extend( ['xsec=2.6918',	'kfact=1.000',		'ref=KF'] ) # 24.60*0.501*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M145']      .extend( ['xsec=3.0363',	'kfact=1.000',		'ref=KF'] ) # 23.17*0.600*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M150']      .extend( ['xsec=3.3291',	'kfact=1.000',		'ref=KF'] ) # 21.90*0.696*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M155']      .extend( ['xsec=3.6220',	'kfact=1.000',		'ref=KF'] ) # 20.86*0.795*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M160']      .extend( ['xsec=3.9742',	'kfact=1.000',		'ref=KF'] ) # 20.04*0.908*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M165']      .extend( ['xsec=3.9460',	'kfact=1.000',		'ref=KF'] ) # 18.82*0.960*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M170']      .extend( ['xsec=3.7667',	'kfact=1.000',		'ref=KF'] ) # 17.89*0.964*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M175']      .extend( ['xsec=3.5675',	'kfact=1.000',		'ref=KF'] ) # 17.05*0.958*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M180']      .extend( ['xsec=3.3200',	'kfact=1.000',		'ref=KF'] ) # 16.31*0.932*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M190']      .extend( ['xsec=2.5356',	'kfact=1.000',		'ref=KF'] ) # 14.77*0.786*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M200']      .extend( ['xsec=2.1946',	'kfact=1.000',		'ref=KF'] ) # 13.56*0.741*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M210']      .extend( ['xsec=2.0054',	'kfact=1.000',		'ref=KF'] ) # 12.70*0.723*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M230']      .extend( ['xsec=1.7334',	'kfact=1.000',		'ref=KF'] ) # 11.21*0.708*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M250']      .extend( ['xsec=1.5127',	'kfact=1.000',		'ref=KF'] ) # 9.88*0.701*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M270']      .extend( ['xsec=1.3488',	'kfact=1.000',		'ref=KF'] ) # 8.86*0.697*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M300']      .extend( ['xsec=1.1924',	'kfact=1.000',		'ref=KF'] ) # 7.89*0.692*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M350']      .extend( ['xsec=1.1856',	'kfact=1.000',		'ref=KF'] ) # 8.03*0.676*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M400']      .extend( ['xsec=0.9071',	'kfact=1.000',		'ref=KF'] ) # 7.136*0.582*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M450']      .extend( ['xsec=0.5930',     	'kfact=1.000',		'ref=EF'] ) # 4.9279*0.551*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M500']      .extend( ['xsec=0.4007',	'kfact=1.000',		'ref=KF'] ) # 3.360*0.546*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M550']      .extend( ['xsec=0.2654',	'kfact=1.000',		'ref=KF'] ) # 2.209*0.550*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M600']      .extend( ['xsec=0.1789',	'kfact=1.000',		'ref=KF'] ) # 1.468*0.558*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M650']      .extend( ['xsec=0.1259',     	'kfact=1.000',		'ref=EF'] ) # 1.0149*0.568*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M700']      .extend( ['xsec=0.0866',	'kfact=1.000',		'ref=KF'] ) # 0.687*0.577*0.108*3*0.6741
...
samples['GluGluHToWWToLNuQQ_M800']      .extend( ['xsec=0.0453',	'kfact=1.000',		'ref=KF'] ) # 0.3493*0.594*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M900']      .extend( ['xsec=0.0255',	'kfact=1.000',		'ref=KF'] ) # 0.1920*0.609*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M1000']     .extend( ['xsec=0.0161',     	'kfact=1.000',		'ref=EF'] ) # 0.11877*0.621*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M1500']     .extend( ['xsec=0.0020',        'kfact=1.000',          'ref=KF'] ) # 0.01465*0.621*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M2000']     .extend( ['xsec=0.00084',       'kfact=1.000',          'ref=KF'] ) # 0.006227*0.621*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M2500']     .extend( ['xsec=0.00034',       'kfact=1.000',          'ref=KF'] ) # 0.002515*0.621*0.108*3*0.6741
samples['GluGluHToWWToLNuQQ_M3000']     .extend( ['xsec=0.00016',       'kfact=1.000',          'ref=KF'] ) # 0.001186*0.621*0.108*3*0.6741
...
samples['VBFHToWWTo2L2Nu_M1500']        .extend( ['xsec=0.0029',        'kfact=1.000',          'ref=KF'] ) # 0.04471*0.621*0.108*0.108*9
samples['VBFHToWWTo2L2Nu_M2000']        .extend( ['xsec=0.0023',        'kfact=1.000',          'ref=KF'] ) # 0.03488*0.621*0.108*0.108*9
samples['VBFHToWWTo2L2Nu_M2500']        .extend( ['xsec=0.0015',        'kfact=1.000',          'ref=KF'] ) # 0.02165*0.621*0.108*0.108*9
samples['VBFHToWWTo2L2Nu_M3000']        .extend( ['xsec=0.00092',       'kfact=1.000',          'ref=KF'] ) # 0.01413*0.621*0.108*0.108*9
...
samples['VBFHToWWToLNuQQ_M115']		.extend( ['xsec=0.0767',	'kfact=1.000',		'ref=EF'] ) # 4.09*0.0859*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M120']		.extend( ['xsec=0.1207',	'kfact=1.000',		'ref=KF'] ) # 3.92*0.141*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M124']		.extend( ['xsec=0.1651',	'kfact=1.000',		'ref=EF'] ) # 3.80*0.199*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M125']		.extend( ['xsec=0.1761',	'kfact=1.000',		'ref=EF'] ) # 3.75*0.215*0.108*3*0.6741 YR value
samples['VBFHToWWToLNuQQ_M126']		.extend( ['xsec=0.1887',	'kfact=1.000',		'ref=KF'] ) # 3.74*0.231*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M130']		.extend( ['xsec=0.2396',	'kfact=1.000',		'ref=KF'] ) # 3.62*0.303*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M135']		.extend( ['xsec=0.3049',	'kfact=1.000',		'ref=KF'] ) # 3.49*0.400*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M140']		.extend( ['xsec=0.3688',	'kfact=1.000',		'ref=KF'] ) # 3.37*0.501*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M145']		.extend( ['xsec=0.4259',	'kfact=1.000',		'ref=KF'] ) # 3.25*0.600*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M150']		.extend( ['xsec=0.4788',	'kfact=1.000',		'ref=KF'] ) # 3.15*0.696*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M155']		.extend( ['xsec=0.5313',	'kfact=1.000',		'ref=KF'] ) # 3.06*0.795*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M160']		.extend( ['xsec=0.5949',	'kfact=1.000',		'ref=KF'] ) # 3.00*0.908*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M165']		.extend( ['xsec=0.6060',	'kfact=1.000',		'ref=KF'] ) # 2.89*0.960*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M170']		.extend( ['xsec=0.5874',	'kfact=1.000',		'ref=KF'] ) # 2.79*0.964*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M175']		.extend( ['xsec=0.5649',	'kfact=1.000',		'ref=KF'] ) # 2.70*0.958*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M180']		.extend( ['xsec=0.5333',	'kfact=1.000',		'ref=KF'] ) # 2.62*0.932*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M190']		.extend( ['xsec=0.4189',	'kfact=1.000',		'ref=KF'] ) # 2.44*0.786*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M200']		.extend( ['xsec=0.3706',	'kfact=1.000',		'ref=KF'] ) # 2.29*0.741*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M210']		.extend( ['xsec=0.3442',	'kfact=1.000',		'ref=KF'] ) # 2.18*0.723*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M230']		.extend( ['xsec=0.2938',	'kfact=1.000',		'ref=KF'] ) # 1.9*0.708*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M250']		.extend( ['xsec=0.2678',	'kfact=1.000',		'ref=KF'] ) # 1.75*0.701*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M270']		.extend( ['xsec=0.2374',	'kfact=1.000',		'ref=KF'] ) # 1.56*0.697*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M300']		.extend( ['xsec=0.1998',	'kfact=1.000',		'ref=KF'] ) # 1.322*0.692*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M350']		.extend( ['xsec=0.1528',	'kfact=1.000',		'ref=KF'] ) # 1.035*0.676*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M400']		.extend( ['xsec=0.1069',	'kfact=1.000',		'ref=KF'] ) # 0.841*0.582*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M450']		.extend( ['xsec=0.0824',	'kfact=1.000',		'ref=KF'] ) # 0.685*0.551*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M500']		.extend( ['xsec=0.0664',	'kfact=1.000',		'ref=KF'] ) # 0.557*0.546*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M550']		.extend( ['xsec=0.0549',	'kfact=1.000',		'ref=KF'] ) # 0.457*0.550*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M600']		.extend( ['xsec=0.0461',	'kfact=1.000',		'ref=KF'] ) # 0.378*0.558*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M650']		.extend( ['xsec=0.0397',	'kfact=1.000',		'ref=KF'] ) # 0.320*0.568*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M700']		.extend( ['xsec=0.0339',	'kfact=1.000',		'ref=KF'] ) # 0.269*0.577*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M750']		.extend( ['xsec=0.0319',	'kfact=1.000',		'ref=KF'] ) # 0.235*0.621*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M750_NWA']	.extend( ['xsec=0.0252',	'kfact=1.000',		'ref=KF'] ) # 0.186*0.621*0.108*3*0.6741 - shall we keep the same BR for NWA?
samples['VBFHToWWToLNuQQ_M800']		.extend( ['xsec=0.0259',	'kfact=1.000',		'ref=KF'] ) # 0.200*0.594*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M900']		.extend( ['xsec=0.0208',	'kfact=1.000',		'ref=KF'] ) # 0.1547*0.609*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M1000']	.extend( ['xsec=0.0170',	'kfact=1.000',		'ref=KF'] ) # 0.125*0.621*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M1500']        .extend( ['xsec=0.0060',        'kfact=1.000',          'ref=KF'] ) # 0.04471*0.621*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M2000']        .extend( ['xsec=0.0047',        'kfact=1.000',          'ref=KF'] ) # 0.03488*0.621*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M2500']        .extend( ['xsec=0.0029',        'kfact=1.000',          'ref=KF'] ) # 0.02165*0.621*0.108*3*0.6741
samples['VBFHToWWToLNuQQ_M3000']        .extend( ['xsec=0.0019',        'kfact=1.000',          'ref=KF'] ) # 0.01413*0.621*0.108*3*0.6741
...
samples['QCD_Pt-80to120_MuEnrichedPt5_ext1']    .extend( ['xsec=2758420', 	'kfact=1.000',	'ref=EN'] )
...
samples['QCD_Pt-800to1000_MuEnrichedPt5']       .extend( ['xsec=32.3486',  	'kfact=1.000',	'ref=EN'] )    
samples['QCD_Pt-1000toInf_MuEnrichedPt5']       .extend( ['xsec=10.4305',  	'kfact=1.000',	'ref=EN'] )    
...
samples['QCD_Pt-15to20_EMEnriched_ext1']       	.extend( ['xsec=1273000000',	'kfact=1.000',	'ref=N'] )  # It is 1279000000 in ref E
...
samples['QCD_Pt-80to120_EMEnriched']       	.extend( ['xsec=2800000',  	'kfact=1.000',	'ref=EN'] )
samples['QCD_Pt-120to170_EMEnriched']       	.extend( ['xsec=477000',  	'kfact=1.000',	'ref=EN'] )
samples['QCD_Pt-170to300_EMEnriched']       	.extend( ['xsec=114000',  	'kfact=1.000',	'ref=EN'] )
samples['QCD_Pt-300toInf_EMEnriched']       	.extend( ['xsec=9000',  	'kfact=1.000',	'ref=EN'] )
