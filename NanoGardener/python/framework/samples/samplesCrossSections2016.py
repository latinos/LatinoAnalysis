...
samples['WJetsToLNu_Pt-100To250']                	.extend( ['xsec=676.3',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-100To250_ext1']                	.extend( ['xsec=676.3',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-100To250_ext4']                	.extend( ['xsec=676.3',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-250To400']                	.extend( ['xsec=23.94',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-250To400_ext1']                	.extend( ['xsec=23.94',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-250To400_ext4']                	.extend( ['xsec=23.94',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-400To600']                	.extend( ['xsec=3.031',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-400To600_ext1']                	.extend( ['xsec=3.031',	'kfact=1.00',		'ref=I'] )
samples['WJetsToLNu_Pt-600ToInf']                	.extend( ['xsec=0.4524',	'kfact=1.00',		'ref=I'] )
