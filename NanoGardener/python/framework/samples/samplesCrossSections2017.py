...
samples['DYJetsToLL_M-50_HT-100to200']       .extend( ['xsec=147.4',	'kfact=1.23',	'ref=E'] ) 
samples['DYJetsToLL_M-50_HT-100to200_ext1']  .extend( ['xsec=147.4',	'kfact=1.23',	'ref=E'] )  
samples['DYJetsToLL_M-50_HT-100to200_newpmx'].extend( ['xsec=147.4',	'kfact=1.23',	'ref=E'] ) 
...
samples['DYJetsToLL_M-50_HT-400to600_newpmx'].extend( ['xsec=5.678',	'kfact=1.23',	'ref=E'] ) 
...
samples['DYJetsToTT_MuEle_M-50']             .extend( ['xsec=250.997',    'kfact=1.000',          'ref=X'] )  # (6077.22/3)*(0.352)^2
samples['DYJetsToTT_MuEle_M-50_ext1']        .extend( ['xsec=250.997',    'kfact=1.000',          'ref=X'] )  # (6077.22/3)*(0.352)^2
samples['DYJetsToTT_MuEle_M-50_PSWeights']   .extend( ['xsec=250.997',    'kfact=1.000',          'ref=X'] )  # (6077.22/3)*(0.352)^2
samples['DYJetsToTT_MuEle_M-50_fix']         .extend( ['xsec=250.997',    'kfact=1.000',          'ref=X'] )  # (6077.22/3)*(0.352)^2
######################
...
samples['ZZTo4L_new_pmx']               .extend( ['xsec=1.256000',	'kfact=1.000',		'ref=E'] )
...
samples['ST_t-channel_antitop_5f_new_pmx'].extend( ['xsec=80.95',         'kfact=1.000',          'ref=D'] )
samples['ST_tW_antitop_PSweights']        .extend( ['xsec=35.85',         'kfact=1.000',          'ref=D'] )
samples['ST_tW_top_PSweights']            .extend( ['xsec=35.85',         'kfact=1.000',          'ref=D'] )
############
...
# Polarized EW WZ
# Updated! In agreement with 2016
