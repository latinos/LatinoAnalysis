...
#################################### nAODv8 UL DATA  ##############################################
 ...
 'Run2017_UL2017_nAODv8_Full2017v8': {
                       ...
                       'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Run2017_UL2017_nAODv8.py' ,
                       'cmssw'   : 'Full2017v8',
                       'year'    : '2017' ,
                   },

 # -------- 2018 DATA UL2018 nAODv8: Full2018v8
 'Run2018_UL2018_nAODv8_Full2018v8': {
                       'isData'  : True ,
                       ...
                       'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Run2018_UL2018_nAODv8.py' ,
                       'cmssw'   : 'Full2018v8',
                       'year'    : '2018' ,
                   },
...
#################################### nAODv9 UL DATA  ##############################################
 ...
 'Run2017_UL2017_nAODv9_Full2017v9': {
                       'isData'  : True ,
                       'jsonFile'   : '"%s/src/LatinoAnalysis/NanoGardener/python/data/certification/Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt"  % os.environ["CMSSW_BASE"]',
                       'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Run2017_UL2017_nAODv9.py' ,
                       'cmssw'   : 'Full2017v9',
                       'year'    : '2017' ,
                   },
 ...
 'Run2018_UL2018_nAODv9_Full2018v9': {
                       'isData'  : True ,
                       'jsonFile'   : '"%s/src/LatinoAnalysis/NanoGardener/python/data/certification/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt"  % os.environ["CMSSW_BASE"]',
                       'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Run2018_UL2018_nAODv9.py' ,
                       'cmssw'   : 'Full2018v9',
                       'year'    : '2018' ,
                   },
...
#################################### nAODv8 MC ##############################################
 ...
 'Summer20UL17_106x_nAODv8_Full2017v8' : {
                       'isData'  : False ,
                       'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Summer20UL17_106x_nAODv2.py',
                       'cmssw'   : 'Full2017v8',
                       'year'    : '2017' ,
 #                      'JESGT'   : 'Fall17_17Nov2017_V32_MC' ,
                       'xsFile'  : 'LatinoAnalysis/NanoGardener/python/framework/samples/samplesCrossSections2017.py' ,
 ...
 'Summer20UL18_106x_nAODv8_Full2018v8' : {
                       'isData'  : False ,
                       'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Summer20UL18_106x_nAODv2.py',
                       'cmssw'   : 'Full2018v8',
                       'year'    : '2018' ,
 #                      'JESGT'   : 'Autumn18_V19_MC',
                       'xsFile'  : 'LatinoAnalysis/NanoGardener/python/framework/samples/samplesCrossSections2018.py' ,
...
'Summer20UL16_106x_nAODv9_HIPM_Full2016v9': {
                      'isData'  : False ,
                      'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Summer20UL16_106x_HIPM_nAODv9.py' ,
                      'cmssw'   : 'Full2016v9HIPM' ,
                      'year'    : '2016' ,
#                      'JESGT'   : 'Summer16_07Aug2017_V11_MC' ,
                      'xsFile'  : 'LatinoAnalysis/NanoGardener/python/framework/samples/samplesCrossSections2016.py' ,
...
'Summer20UL16_106x_nAODv9_noHIPM_Full2016v9': {
                      'isData'  : False ,
                      'samples' : 'LatinoAnalysis/NanoGardener/python/framework/samples/Summer20UL16_106x_noHIPM_nAODv9.py' ,
                      'cmssw'   : 'Full2016v9noHIPM' ,
                      'year'    : '2016' ,
#                      'JESGT'   : 'Summer16_07Aug2017_V11_MC' ,
                      'xsFile'  : 'LatinoAnalysis/NanoGardener/python/framework/samples/samplesCrossSections2016.py' ,
