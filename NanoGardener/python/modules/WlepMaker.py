...
class WlepMaker(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        for typ in Wlep_br:
           for var in Wlep_br[typ]:
              if 'Wlep_' in var: self.out.branch(var, typ)
    ...
    def analyze(self, event):
       ...
       wlep_dict['pt']   = v_wlep.Pt()
       wlep_dict['eta']  = v_wlep.Eta()
       wlep_dict['phi']  = v_wlep.Phi()
       wlep_dict['mass'] = v_wlep.M()
       wlep_dict['px'] = v_wlep.Px()
       wlep_dict['py'] = v_wlep.Py()
       wlep_dict['pz'] = v_wlep.Pz()
       wlep_dict['E'] = v_wlep.E()
