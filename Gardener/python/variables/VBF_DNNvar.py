...
smodel = baseCMSSW+"/src/LatinoAnalysis/Gardener/python/vbfdnn/model1.json"
#smodel = "/afs/cern.ch/user/l/lusanche/KERAS/run_dnn/model.json"
sweight = baseCMSSW+"/src/LatinoAnalysis/Gardener/python/vbfdnn/model1_weights_json.h5"
