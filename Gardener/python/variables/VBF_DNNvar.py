...
smodel = baseCMSSW+"/src/LatinoAnalysis/Gardener/python/vbfdnn/model.json"
#smodel = "/afs/cern.ch/user/l/lusanche/KERAS/run_dnn/model.json"
sweight = baseCMSSW+"/src/LatinoAnalysis/Gardener/python/vbfdnn/model_weights_json.h5"
