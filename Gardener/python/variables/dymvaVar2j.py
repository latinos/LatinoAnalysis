...
class DymvaVar2jFiller(TreeCloner):
        ...
        for i in xrange(nentries):
           ...
           # just because it is easier to write later ...
            ...
            if pt1>0 and pt2>0 : 
              ...
              if jetpt1< 30.0 :
              ...
              elif jetpt1>= 30.0 and jetpt2>= 30.0 and detajj<3.5:
              ...
              elif jetpt1>= 30.0 and jetpt2>= 30.0 and detajj>=3.5 and mjj>=400:
                    ...
                    dymvaggh[0] = self.getDYMVAV2jVBF.EvaluateMVA("BDT")
