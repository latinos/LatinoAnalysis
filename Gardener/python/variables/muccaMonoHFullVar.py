...
class MuccaMonoHFullVarFiller(TreeCloner):
    ...
    def createMuccaMonoHFull(self):
        ...
        self.getMuccaMonoHFull.BookMVA("BDT","/afs/cern.ch/user/n/ntrevisa/work/CMSSW_8_0_5/src/MUCCA/Optimization/Weights-" + self.model + "_TTbar_0var_" + self.channel + "/TMVAClassification_" + self.training + ".weights.xml")
