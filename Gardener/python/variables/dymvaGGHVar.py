...
class DymvaGGHVarFiller(TreeCloner):
    ...
    def createDYMVA(self):
        ...
        self.getDYMVAV0j.AddVariable("mth",            (self.var0j2))   
        self.getDYMVAV0j.AddVariable("ptll",           (self.var0j3))   
        self.getDYMVAV0j.AddVariable("projtkmet",      (self.var0j4))   
        self.getDYMVAV0j.AddVariable("projpfmet",      (self.var0j5))   
        self.getDYMVAV0j.AddVariable("jetpt1_cut",     (self.var0j6))   
        self.getDYMVAV0j.AddVariable("uperp",          (self.var0j7))   
        self.getDYMVAV0j.AddVariable("upara",          (self.var0j8))   
        self.getDYMVAV0j.AddVariable("mtw1",           (self.var0j9))   
        self.getDYMVAV0j.AddVariable("PfMetDivSumMet", (self.var0j10))   
        self.getDYMVAV0j.AddVariable("metPuppi",       (self.var0j11))   
        self.getDYMVAV0j.AddVariable("dphillmet",      (self.var0j12))   
        self.getDYMVAV0j.AddVariable("recoil",         (self.var0j13))   
        self.getDYMVAV0j.AddVariable("dphilljet_cut",  (self.var0j14))   
        self.getDYMVAV0j.AddVariable("dphilmet1",      (self.var0j15))   
        self.getDYMVAV0j.AddVariable("mpmet",          (self.var0j16))   
        ...
        self.getDYMVAV1j.AddVariable("mth",               (self.var1j2))
        self.getDYMVAV1j.AddVariable("mpmet",             (self.var1j3))
        self.getDYMVAV1j.AddVariable("projtkmet",         (self.var1j4))
        self.getDYMVAV1j.AddVariable("projpfmet",         (self.var1j5))
        self.getDYMVAV1j.AddVariable("upara",             (self.var1j6))
        self.getDYMVAV1j.AddVariable("jetpt1_cut",        (self.var1j7))
        self.getDYMVAV1j.AddVariable("PfMetDivSumMet",    (self.var1j8))
        self.getDYMVAV1j.AddVariable("dphilljet_cut",     (self.var1j9))
        self.getDYMVAV1j.AddVariable("nvtx",              (self.var1j10))
        self.getDYMVAV1j.AddVariable("metPuppi",          (self.var1j11))
        self.getDYMVAV1j.AddVariable("dphijet1met_cut",   (self.var1j12))
        ...
        self.getDYMVAV0j.BookMVA("BDT",baseCMSSW+"/src/LatinoAnalysis/Gardener/python/data/dymva/UATmva_DYmva_0j_BDTG_16Var.weights.xml")
        self.getDYMVAV1j.BookMVA("BDT",baseCMSSW+"/src/LatinoAnalysis/Gardener/python/data/dymva/UATmva_DYmva_1j_BDTG_12Var.weights.xml")
    ...
    def process(self,**kwargs):
        ...
        self.var0j13 = array.array('f',[0])
        self.var0j14 = array.array('f',[0])
        self.var0j15 = array.array('f',[0])
        self.var0j16 = array.array('f',[0])
        ...
        self.var1j11 = array.array('f',[0])
        self.var1j12 = array.array('f',[0])
...
#                   self.var0j9[0] = itree.upara
                    ...
                    self.var0j2[0] = itree.mth
                    self.var0j3[0] = itree.ptll
                    self.var0j4[0] = itree.projtkmet
                    self.var0j5[0] = itree.projpfmet
                    self.var0j6[0] = itree.jetpt1_cut
                    self.var0j7[0] = itree.uperp
                    self.var0j8[0] = itree.upara
                    self.var0j9[0] = itree.mtw1
                    self.var0j10[0] = itree.PfMetDivSumMet
                    self.var0j11[0] = itree.metPuppi
                    self.var0j12[0] = itree.dphillmet
                    self.var0j13[0] = itree.recoil
                    self.var0j14[0] = itree.dphilljet_cut
                    self.var0j15[0] = itree.dphilmet1
                    self.var0j16[0] = itree.mpmet
                    ...
                    self.var1j2[0]  = itree.mth
                    self.var1j3[0]  = itree.mpmet
                    self.var1j4[0]  = itree.projtkmet
                    self.var1j5[0]  = itree.projpfmet
                    self.var1j6[0]  = itree.upara
                    self.var1j7[0]  = itree.jetpt1_cut
                    self.var1j8[0]  = itree.PfMetDivSumMet
                    self.var1j9[0]  = itree.dphilljet_cut
                    self.var1j10[0] = itree.nvtx
                    self.var1j11[0] = itree.metPuppi
                    self.var1j12[0] = itree.dphijet1met_cut
