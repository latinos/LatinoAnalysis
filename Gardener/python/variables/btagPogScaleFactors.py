...
class btagPogScaleFactors(TreeCloner):
    ...
    def checkOptions(self,opts):
        ...
        self.readerCentral = ROOT.BTagCalibrationReader(self.calib, wp, "mujets", "central")  # 0 is for loose op
        self.readerUp = ROOT.BTagCalibrationReader(self.calib, wp, "mujets", "up")  # 0 is for loose op
        self.readerDown = ROOT.BTagCalibrationReader(self.calib, wp, "mujets", "down")  # 0 is for loose op
        ...
        self.readerLightCentral = ROOT.BTagCalibrationReader(self.calib, wp, "comb", "central")  # 0 is for loose op
        self.readerLightUp = ROOT.BTagCalibrationReader(self.calib, wp, "comb", "up")  # 0 is for loose op
        self.readerLightDown = ROOT.BTagCalibrationReader(self.calib, wp, "comb", "down")  # 0 is for loose op
        ...
        for i in xrange(nentries):
            ...
            for iJet in xrange(len(itree.std_vector_jet_pt)) :
              ...
              if pt > self.minpt and abs(eta) < self.maxeta:
                ...
                #print "sf, sfUp, sfDown", sf, sfUp, sfDown 
