...
class triggerMaker(TreeCloner):
    ...
    def process(self,**kwargs):
        ...
        for i in xrange(nentries):
            ...
            self.branches['veto_EMTFBug'] = self.triggerCalculators[self.runPeriod-1]._getEMTFBugVeto(itree.std_vector_lepton_flavour,itree.std_vector_lepton_pt,itree.std_vector_lepton_eta)
