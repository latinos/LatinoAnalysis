        ...
        if not 'UEPS' == iStep :
         if 'iihe' in os.uname()[1]:
           if startingStep == 'Prod' :
             ...
             command+='pwd;ls -l;voms-proxy-info;lcg-cp -v -v '+outTree+' '+'srm://maite.iihe.ac.be:8443/pnfs/iihe/cms/store/user/xjanssen/HWW2015/'+iProd+'/'+iStep+'/latino_'+iTarget+'.root'
