...
for Run in B C D E F G H; do 
 ...
 ./mkGardener.py -p Apr2017_Run2016${Run}_RemAOD -s EpTCorr,TrigMakerData,l2tight -C -i lep2SelVBS__hadd -S Target -b -W 8:00:00
 ./mkGardener.py -p Apr2017_Run2016${Run}_RemAOD -s TrigMakerData -i lep2SelVBS__hadd__EpTCorr -S Target -b -W 8:00:00
 ./mkGardener.py -p Apr2017_Run2016${Run}_RemAOD -s l2tight -i lep2SelVBS__hadd__EpTCorr__TrigMakerData -S Target -b -W 8:00:00
 
  # Skims 

 for iSkim in vh3lSel vbsSel tightVbsSel; do
   ./mkGardener.py -p Apr2017_Run2016${Run}_RemAOD -s ${iSkim} -i lep2SelVBS__hadd__EpTCorr__TrigMakerData__l2tight -S Target -b -W 1:00:00
 done
